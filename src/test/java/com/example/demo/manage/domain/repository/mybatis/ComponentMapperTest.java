...
public class ComponentMapperTest {
	...
	void searchComp1Test() throws Exception {
		{
			String id = "9999";
			boolean flag = true;
			int status = 0;
			List<Component> actual = mapper.searchComp1(id,flag,status);
			assertThat(actual.size(),is(1));
			assertThat(actual.get(0).getComponentId(),is("99999999"));
			assertThat(actual.get(0).getComponentCd(),is("TEST"));
			assertThat(actual.get(0).getComponentName(),is("testcomponent"));
	...
	void searchComp2Test() throws Exception {
		{
			String cd = "TES";
			boolean flag = true;
			int status = 0;
			List<Component> actual = mapper.searchComp2(cd,flag,status);
			assertThat(actual.size(),is(1));
			assertThat(actual.get(0).getComponentId(),is("99999999"));
			assertThat(actual.get(0).getComponentCd(),is("TEST"));
			assertThat(actual.get(0).getComponentName(),is("testcomponent"));
	...
	void searchComp3Test() throws Exception {
		{
			String name = "test";
			boolean flag = true;
			int status = 0;
			List<Component> actual = mapper.searchComp3(name,flag,status);
			assertThat(actual.size(),is(1));
			assertThat(actual.get(0).getComponentId(),is("99999999"));
			assertThat(actual.get(0).getComponentCd(),is("TEST"));
			assertThat(actual.get(0).getComponentName(),is("testcomponent"));
	...
	void searchComp4Test() throws Exception {
		{
			String cd = "TES";
			String name = "test";
			boolean flag = true;
			int status = 0;
			List<Component> actual = mapper.searchComp4(cd,name,flag,status);
			assertThat(actual.size(),is(1));
			assertThat(actual.get(0).getComponentId(),is("99999999"));
			assertThat(actual.get(0).getComponentCd(),is("TEST"));
			assertThat(actual.get(0).getComponentName(),is("testcomponent"));
	...
	void searchComp5Test() throws Exception {
		{
			String id = "9999";
			String name = "test";
			boolean flag = true;
			int status = 0;
			List<Component> actual = mapper.searchComp5(id,name,flag,status);
			assertThat(actual.size(),is(1));
			assertThat(actual.get(0).getComponentId(),is("99999999"));
			assertThat(actual.get(0).getComponentCd(),is("TEST"));
			assertThat(actual.get(0).getComponentName(),is("testcomponent"));
	...
	void searchComp6Test() throws Exception {
		{
			String id = "9999";
			String cd = "TES";
			boolean flag = true;
			int status = 0;
			List<Component> actual = mapper.searchComp6(id,cd,flag,status);
			assertThat(actual.size(),is(1));
			assertThat(actual.get(0).getComponentId(),is("99999999"));
			assertThat(actual.get(0).getComponentCd(),is("TEST"));
			assertThat(actual.get(0).getComponentName(),is("testcomponent"));
